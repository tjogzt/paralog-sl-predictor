...
Esophagogastric & \shortstack[l]{Esophagogastric adenocarcinoma /\\esophageal SCC} & 62 & 85 & 8 & 0.805 \\
...
\bottomrule
\end{tabular}
\caption{DD AUROC across all 17 evaluable solid tumor types (sorted by AUROC). Horizontal line separates AUROC~$>$~0.7 (top) from AUROC~$\le$~0.7 (bottom). Full lineage names are given in Table~S1.}
\end{table}
