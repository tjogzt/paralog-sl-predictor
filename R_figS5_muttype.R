# FigS5 — Mutation Type Stratification (R)
...
save_panel <- function(p, name) {
  ggsave(file.path(OUT_DIR, paste0("FigS5_panel_", name, ".pdf")), p,
...
# MAIN
# ═══════════════════════════════════════════════════════════════
message("=== FigS5 Panel Generation (R) ===")
...
ggsave(file.path(OUT_DIR, "FigS5_MutationType.pdf"), p,
       width = 180, height = 180, units = "mm", device = cairo_pdf)
ggsave(file.path(OUT_DIR, "FigS5_MutationType.svg"), p,
       width = 180, height = 180, units = "mm", device = svglite::svglite)
ggsave(file.path(OUT_DIR, "FigS5_MutationType.tiff"), p,
       width = 180, height = 180, units = "mm", device = ragg::agg_tiff, dpi = 600)
message("FigS5_MutationType.pdf (180×180mm) ✓")
