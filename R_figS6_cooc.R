# FigS6 — Mutational co-occurrence by lineage, with and without TMB adjustment (R)
...
ggsave(file.path(OUT_DIR, "FigS6_panel_a.pdf"), pa,
       width = 90, height = 95, units = "mm", device = cairo_pdf)
ggsave(file.path(OUT_DIR, "FigS6_panel_b.pdf"), pb,
       width = 90, height = 95, units = "mm", device = cairo_pdf)
...
ggsave(file.path(OUT_DIR, "FigS6_Cooccurrence_TMB.pdf"), p,
       width = 180, height = 95, units = "mm", device = cairo_pdf)
ggsave(file.path(OUT_DIR, "FigS6_Cooccurrence_TMB.svg"), p,
       width = 180, height = 95, units = "mm", device = svglite::svglite)
ggsave(file.path(OUT_DIR, "FigS6_Cooccurrence_TMB.tiff"), p,
       width = 180, height = 95, units = "mm", device = ragg::agg_tiff, dpi = 600)
message("FigS6_Cooccurrence_TMB.pdf (180×95mm) ✓")
