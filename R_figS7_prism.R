...
theme_bar <- theme_classic(base_size = 7, base_family = "Arial") + theme(
  ...
  axis.text.x  = element_text(size = TICK_FS, margin = margin(t = 2, unit = "pt")),
  axis.title.x = element_text(size = BASE_FS, margin = margin(t = 0, unit = "pt")),
  axis.title.y = element_text(size = BASE_FS),
