...
\textbf{d}, Component decomposition: DD (AUROC~$=$~0.676) versus PCS (0.825), $\Delta$Expression alone (0.547), and necessity (0.642). Inset: pair-level bootstrap distribution (1,000 iterations; dashed lines, 95\% CI; solid line, observed). Full bootstrap and negative control in Supplementary Fig.~S8.}
\label{fig:framework}
\end{figure}
