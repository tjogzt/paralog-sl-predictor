...
All analysis code is available under the MIT license at \url{https://github.com/tjogzt/paralogSL} (DOI: \href{https://doi.org/10.5281/zenodo.21502114}{10.5281/zenodo.21502114}). The complete analysis pipeline (DOI: \href{https://doi.org/10.5281/zenodo.21502031}{10.5281/zenodo.21502031}) is available at \url{https://github.com/tjogzt/paralog-sl-predictor}. The \texttt{paralogSL} R package (v1.0.0, 48 exported functions) provides DD computation, benchmark comparison, therapeutic window analysis, CPTAC visualization, and clinical decision support (\texttt{predict\_trial\_response}, \texttt{visualize\_dependency\_shift}). Random seeds (\texttt{set.seed(42)} in R, \texttt{random\_state=42} in Python) are fixed throughout.
